...
#+begin_src scheme :results output :exports both
  ...
  (define omit
    '(let ((yacht (lambda (father)
       ...
       (let ((moore (amb 'gabrielle 'lorna 'rosalind 'melissa 'mary-ann))
             ...
             (parker (amb 'gabrielle 'lorna 'rosalind 'melissa 'mary-ann)))
         ;; Given
         ;; (require (eq? moore 'mary-ann)) ;; Changed
         (require (eq? barnacle 'melissa))
         ;; Yachts
         (require (not (eq? hall (yacht 'hall))))
         (require (not (eq? downing (yacht 'downing))))
  ...
  (map print (mc-eval omit))
#+end_src

#+RESULTS:
: Original problem
: ((barnacle melissa) (moore mary-ann) (hall gabrielle) (downing lorna) (parker rosalind))
:
: Omitting Mary Ann's last name
: ((barnacle melissa) (moore lorna) (hall gabrielle) (downing mary-ann) (parker rosalind))
: ((barnacle melissa) (moore mary-ann) (hall gabrielle) (downing lorna) (parker rosalind))
