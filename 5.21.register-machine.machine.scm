...
(define (make-machine ops controller-text)
  (let ((machine (make-new-machine))
        (mem-len 128))
    (set-register-contents! machine 'the-cars (make-vector mem-len))
    (set-register-contents! machine 'the-cdrs (make-vector mem-len))
  ...
  (let ((pc (make-register 'pc))
    ...
    (let ((the-ops
          ...
          (register-table
           (list (list 'pc pc)
                 (list 'flag flag)
                 (list 'the-cars the-cars)
                 (list 'the-cdrs the-cdrs))))
