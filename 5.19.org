...
* Answer
We can implement breakpoints by leveraging the instruction text in ~execute~ to monitor for ~branch~ and ~goto~ statements. Otherwise, we iterate the internal counter and check for any matches with registered breakpoints.
